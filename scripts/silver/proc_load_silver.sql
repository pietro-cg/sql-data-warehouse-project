...
===============================================================================
 ...
 Purpose:
   This stored procedure is responsible for loading data into the Silver
   layer of the Data Warehouse. It performs full refresh loads by truncating
   existing Silver tables and reloading raw data from tables in the Bronze layer
   using BULK INSERT operations.

 Description:
   - Truncates all Silver layer tables before loading new data.
   - Loads data from Bronze tables into corresponding
     Silver tables.
   - Modifies data from Bronze Layer to improve data quality and standartization
   - Captures execution timestamps and prints load duration for each table
     and for the entire batch.

 Data Sources:
   - Corresponding tables from the Data Warehouse Bronze Layer
